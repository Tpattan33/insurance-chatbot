...
def query_rag(query_text: str) -> str:
    ...
    if len(results) == 0 or results[0][1] < 0.7:
        return "I couldn't find enough information to answer that question confidently. For policy-specific questions or additional assistance, please contact NJM Customer Service at 1-800-232-6600 or visit njm.com, where a representative can provide more detailed guidance."
